          ...
          <ol className="ml-12">
            ...
            <li>
              <p className="list-decimal ml-5">
                ...
                вагові візки) - посилаємось на: файл 1-2023-2023-03-06.xlsb
                аркуш «cart» рядок 60 (праворуч аркушу колонки AE-AP).
              </p>
            </li>
            <li>
              <p className="list-decimal ml-5">
            ...
            <li>
              <p className="list-decimal ml-5">
                ...
                посилаємось на: файл 1-2023-2023-03-06.xlsb аркуш «platform»
                рядок 66.
              </p>
            </li>
            <li>
            ...
            <li>
              <p className="list-decimal ml-5">
                9) сер. кількість повідкових візків (з ваговими) в ремонті в
                день – посилаємось на: файл 1-2023-2023-03-06.xlsb аркуш «cart»
                рядок 58 (праворуч аркушу колонки AE-AP).
              </p>
            </li>
            <li>
              <p className="list-decimal ml-5">
                10) сер. кількість повідкових візків (з ваговими) в резерві в
                день – посилаємось на: файл 1-2023-2023-03-06.xlsb аркуш «cart»
                рядок 57 (праворуч аркушу колонки AE-AP).
              </p>
            </li>
          </ol>
